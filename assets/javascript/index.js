...
$(function () {
    ...
    function qtyDecrement(qty_id) {
              ...
              if (($('quantity[id=' + qty_id + ']').text())>1) { // Quantity has to be 1 or more
    ...
    $('body').on('click', '.red' , function() { // To delete elements after they've been  updated
        ...
        if (this.name == "cminus") {
            ...
            if (($('cquant[id=' + this.id + ']').text())>1) { // Quantity has to be more than  1
    ...
    $('body').on('click', '.green' , function() { // To delete elements after they've been  updated
    ...
    $("button").click(function() { // button click function
              ...
              if (this.name == "add") { // if 'Add' button is clicked
              ...
              if (this.name == "minus") { // if 'Remove' button is clicked
            ...
            alert('We love your money :: Come again');
